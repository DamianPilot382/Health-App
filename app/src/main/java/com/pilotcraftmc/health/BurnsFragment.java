...
public class BurnsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View rootView= inflater.inflate(R.layout.fragment_burns, container, false);
        ...
        mItems = getResources().getStringArray(R.array.types_of_burns);

        mDrawerList = (ListView) rootView.findViewById(R.id.list_burns);   //activity_main.xml

        // Set the adapter for the list view
        mDrawerList.setAdapter(new ArrayAdapter<String>(getActivity(), R.layout.burns_list_item, mItems));
